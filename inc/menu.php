...
function trailhead_top_nav() {
	wp_nav_menu(array(
		...
		'items_wrap'		=> '<ul id="%1$s" class="%2$s" data-responsive-menu="accordion tablet-dropdown" data-submenu-toggle="true" data-hover-delay="20" data-closing-time="20">%3$s</ul>',
...
function trailhead_off_canvas_nav() {
	wp_nav_menu(array(
		...
		'items_wrap'		=> '<ul id="%1$s" class="%2$s" data-accordion-menu data-submenu-toggle="true" data-hover-delay="20" data-closing-time="20" data-alignment="left">%3$s</ul>',
